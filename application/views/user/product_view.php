...
<body>
   ...
   <div class="container">
      <div class="text-left mt-5">
         <a href="<?php echo base_url(); ?>LoginVisitante" class="btn btn-info"><ion-icon name="arrow-back-outline"></ion-icon></a>
      </div>
      <div class="text-left mt-5">
         <a href="<?php echo base_url(); ?>nuevo-usuario" class="btn btn-info">Registrar usuario</a>    
      </div>
